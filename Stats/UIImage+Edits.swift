...
public extension UIImage {
    ...
    static func strippedImage(width: CGFloat, height: CGFloat, mainColor: UIColor, stripeColor: UIColor) -> UIImage {
        let context = CIContext()
        let stripes = CIFilter(name: "CIStripesGenerator", withInputParameters: [
            "inputColor0" : CIColor(cgColor: mainColor.cgColor),
            "inputColor1" : CIColor(cgColor: stripeColor.cgColor),
            "inputWidth" : NSNumber(value: 3.0),
